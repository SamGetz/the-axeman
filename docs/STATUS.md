...
| M7C Strength, Technique, Speed slices | Signed off 2026-08-05; 220/220 |
| Runtime slicer | 34/34 |
| M8 and later | Not authorized to start |
...
- `GameplayModifierDef.Kind.WINDUP_TIME` and `SWING_RECOVERY` remain declared
  but unused.
- Final proc odds, caps, bad-luck bounds, node costs, and wind-up cap remain
  labelled tuning placeholders.
...
baseline is M1 19, M2 24, M3 16, M4 55, M7A 285, M7C 220, slicer 34. See
`docs/TESTING.md` for commands and non-headless requirements.
